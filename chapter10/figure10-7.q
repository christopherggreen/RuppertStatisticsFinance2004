...
key(corner=c(0,1), border=T,	points=list(pch=c(45,16,46),cex=c(2,2,2)),
...
for ( i in 1:nresample ) {
	...
	A.resample <- as.numeric(t(bone) %*% ibOmega.resample %*% bmu.true)
	B.resample <- as.numeric(t(bmu.true)  %*% ibOmega.resample %*% bmu.true)
	C.resample <- as.numeric(t(bone) %*% ibOmega.resample %*% bone)
	D.resample <- B.resample * C.resample - A.resample^2

	bg.resample <- (B.resample * ibOmega.resample %*% bone - A.resample * ibOmega.resample %*% bmu.true )/D.resample
	bh.resample <- (C.resample * ibOmega.resample %*% bmu.true  - A.resample * ibOmega.resample %*% bone)/D.resample
